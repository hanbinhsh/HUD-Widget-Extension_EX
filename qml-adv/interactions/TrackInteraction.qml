...
HUDInteractionTemplate {
    ...
    Timer {
        ...
        repeat: true
        running: ctx_widget.exposed && (trackGlobal || mouseArea.containsMouse)
        ...
        onTriggered: {
            ...
            if (trackGlobal) {
                ...
                pitch = rotateRangeY * rotateAmountY(mouseArea.mouseY);
                yaw   = rotateRangeX * rotateAmountX(mouseArea.mouseX);
            }
            if (pitch || yaw) {
